...
const WaterRipple: React.FC<WaterRippleProps> = ({ imageUrl, className, children }) => {
  ...
  useEffect(() => {
    ...
    let rippleData: Int32Array;
    let lastRippleData: Int32Array;
    let textureData: Uint8ClampedArray;
    ...
    const dropAt = (x: number, y: number, radius: number, strength: number) => {
